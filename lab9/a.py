...
class Coins(pygame.sprite.Sprite):
    ...
    def __init__(self, max_weight):
        super().__init__()
        image = pygame.transform.scale(pygame.image.load('./assets/Coin.png'),
    ...
    def gen(self):
        self.coin_list.append(
            (random.randint(Coins.COIN_WIDTH, SCREEN_WIDTH - Coins.COIN_WIDTH), 0, random.randint(1, self.max_weight)))
